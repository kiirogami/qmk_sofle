...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * `-----------------------------------------/       /     \      \-----------------------------------------'
     *            | LGUI | LAlt | LCTR |_EDIT | /Space  /       \Enter \  |_CHARS| RCTR | RAlt | RGUI |
     *            |      |      |      |      |/       /         \      \ |      |      |      |      |
     *            `----------------------------------'           '------''---------------------------'
     */
    ...
    [_QWERTY] = LAYOUT(
      ...
      KC_LSFT,  KC_Z,   KC_X,    KC_C,    KC_V,    KC_B,  KC_MUTE,       TETR,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                        KC_LGUI, KC_LALT, KC_LCTL, EDIT,  KC_SPC,      KC_ENT, CHARS, KC_RCTL,    KC_RALT, KC_RGUI
    ),
     ...
     */
    [_EDIT] = LAYOUT(
        _______, KC_LCAP, KC_PSCR, KC_SCRL, KC_PAUS, XXXXXXX,                         XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
